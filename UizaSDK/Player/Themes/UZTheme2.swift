...
open class UZTheme2: UZPlayerTheme {
	...
	func setupSkin() {
		...
		let playBigIcon = UIImage(icon: FontType.icofont(.playAlt1), size: centerIconSize, textColor: iconColor, backgroundColor: .clear)
		let pauseBigIcon = UIImage(icon: FontType.icofont(.pause), size: centerIconSize, textColor: iconColor, backgroundColor: .clear)
