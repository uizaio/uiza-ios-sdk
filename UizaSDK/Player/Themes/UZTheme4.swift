...
open class UZTheme4: UZPlayerTheme {
	...
	func setupSkin() {
		...
		let backIcon = UIImage(icon: FontType.icofont(.close), size: iconSize, textColor: iconColor, backgroundColor: .clear)
...
//		topFrameLayout!.showFrameDebug = true
		...
		mainFrameLayout = StackFrameLayout(axis: .vertical, distribution: .top)
