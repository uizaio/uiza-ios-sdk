...
open class UZTheme6: UZPlayerTheme {
	...
	func setupSkin() {
		...
		let backIcon = UIImage(icon: FontType.icofont(.close), size: iconSize, textColor: .white, backgroundColor: .clear)
...
//		let pauseBigIcon = UIImage(icon: .googleMaterialDesign(.pauseCircleOutline), size: centerIconSize, textColor: iconColor, backgroundColor: .clear)
		let playIcon = UIImage(icon: FontType.googleMaterialDesign(.playCircleOutline), size: centerIconSize, textColor: iconColor, backgroundColor: .clear)
		let pauseIcon = UIImage(icon: FontType.googleMaterialDesign(.pauseCircleOutline), size: centerIconSize, textColor: iconColor, backgroundColor: .clear)
		...
		let forwardIcon = UIImage(icon: FontType.googleMaterialDesign(.fastForward), size: iconSize, textColor: iconColor, backgroundColor: .clear)
		let backwardIcon = UIImage(icon: FontType.googleMaterialDesign(.fastRewind), size: iconSize, textColor: iconColor, backgroundColor: .clear)
